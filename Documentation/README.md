...
## [Design](02.%20Design)
The Design directory contains documentation that of the design process of this project. Within this directory, you will find resources that outline the core concepts and detailed world building, as well as the overarching storyline and thematic elements. These documents served to align the team on the project's direction, providing a cohesive framework that guides the storytelling, gameplay design, and player experience. This directory acts as a central point for the project's creative blueprint, ensuring consistency and clarity across all design aspects.
