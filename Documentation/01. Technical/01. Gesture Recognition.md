...
## HandShape enum
This enum is used in the [`Gesture` class](../../Assets/Scripts/Gestures/Gesture.cs), this way 2 handshapes can create 1 gesture. It is also used in the [`SequenceManager` script](../../Assets/Scripts/Gestures/SequenceManager.cs) to see if the 2 handshapes that are held are a valid gesture.
